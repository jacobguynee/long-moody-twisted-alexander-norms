...
High complexity f^a g^b tests for B_4.
f = sigma_1, g = sigma_2^2 * sigma_3 * sigma_2^{-2}

Push |a|+|b| from 25 up to 50+.
Uses generic Q=2, a=3; symbolic q.
"""
...
if __name__ == '__main__':
    ...
    print(f'f = sigma_1,  g = sigma_2^2 * sigma_3 * sigma_2^{{-2}}\n')
    ...
    # Test cases: |a|+|b| from 25 to 50, mixed signs, various ratios
    test_cases = [
        # |a|+|b| = 25
        (13, 12),
        (20, -5),
